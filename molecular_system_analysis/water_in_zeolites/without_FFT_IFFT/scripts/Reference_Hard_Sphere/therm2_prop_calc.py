...
if __name__ == '__main__':
   ...
   # Total system data
    ...
    tr_fl, tr_pf_assval = tr_hs_fluidicity(tot_mass, den, tr_dos[0], T, N) # translational fluidicity
    print(tr_fl)
    gas_tr_dos, solid_tr_dos = translational_dos(tr_fl, tr_dos_val, tr_dos, ff) # gas and solid translational dos
    ...
    outd2.close() 
    W_Shs_tr = hs_tr_entropy_wf(tr_fl, tot_mass, den, tr_pf_assval) # hs approx. translational entropy weighing function 
    W_Ahs_tr = 0.5 - W_Shs_tr # hs approx. translational helmholtz energy weighing function
    W_Ehs_tr = 0.5 # hs approx. translational internal energy weighing function
    tr_s_cho, tr_s_qho, tr_s_gas, tr_s_cho1, tr_s_qho1 = entropy(W_Shs_tr, ff, tr_dos, solid_tr_dos, gas_tr_dos) # translational part entropy 
    tr_e_cho, tr_e_qho, tr_e_gas, tr_e_cho1, tr_e_qho1  = energy(W_Ehs_tr, ff, tr_dos, solid_tr_dos, gas_tr_dos) # translational part internal energy
    tr_h_cho, tr_h_qho, tr_h_gas, tr_h_cho1, tr_h_qho1  = helmholtz(W_Ahs_tr, ff, tr_dos, solid_tr_dos, gas_tr_dos) # translational part helmholtz energy
    ...
    W_Ahs_rot = 0.5 - W_Shs_rot # hs approx. rotational helmholtz energy weighing function
    W_Ehs_rot = 0.5 # hs approx. rotational internal energy weighing function
    rot_s_cho, rot_s_qho, rot_s_gas, rot_s_cho1, rot_s_qho1 = entropy(W_Shs_rot, ff, rot_dos, solid_rot_dos, gas_rot_dos) # rotational part entropy 
    rot_e_cho, rot_e_qho, rot_e_gas, rot_e_cho1, rot_e_qho1  = energy(W_Ehs_rot, ff, rot_dos, solid_rot_dos, gas_rot_dos) # rotational part internal energy
    rot_h_cho, rot_h_qho, rot_h_gas, rot_h_cho1, rot_h_qho1  = helmholtz(W_Ahs_rot, ff, rot_dos, solid_rot_dos, gas_rot_dos) # rotational part helmholtz energy
    ...
    # Total system data
    reference = md_energy - ((3*N)*(2 - 0.5*rot_fl - 0.5*tr_fl))/(beta) # reference energy
    ...
    print("Gas part of Total Translational Helmholtz energy of the system (assuming hs approximation for gas part) scales with N (normalized by beta) = ", tr_h_gas/(kb*T), file = out) 
    print("Solid part of Total Translational Helmholtz energy of the system (assuming classical harmonic oscillator for solid part of the system) scales with N (normalized by beta) = ", tr_h_cho1/(kb*T), file = out)
    print("Solid part of Total Translational Helmholtz energy of the system (assuming quantum harmonic oscillator for solid part of the system) scales with N (normalized by beta) = ", tr_h_qho1/(kb*T), file = out)
    ...
    print("Gas part of Total Translational energy of the system (assuming hs approximation for gas part) scales with N (normalized by beta) = ", tr_e_gas/(kb*T), file = out)   
    print("Solid part of Total Translational energy of the system (assuming classical harmonic oscillator for solid part of the system) scales with N (normalized by beta) = ", tr_e_cho1/(kb*T), file = out)
    print("Solid part of Total Translational energy of the system (assuming quantum harmonic oscillator for solid part of the system) scales with N (normalized by beta) = ", tr_e_qho1/(kb*T), file = out)
    ...
    print("Gas part of Total Translational Entropy of the system (assuming hs approximation for gas part) scales with N (normalized by beta) = ", tr_s_gas/(kb), file = out) 
    print("Solid part of Total Translational Entropy of the system (assuming classical harmonic oscillator for solid part of the system) scales with N (normalized by beta) = ", tr_s_cho1/(kb), file = out)
    print("Solid part of Total Translational Entropy of the system (assuming quantum harmonic oscillator for solid part of the system) scales with N (normalized by beta) = ", tr_s_qho1/(kb), file = out)
