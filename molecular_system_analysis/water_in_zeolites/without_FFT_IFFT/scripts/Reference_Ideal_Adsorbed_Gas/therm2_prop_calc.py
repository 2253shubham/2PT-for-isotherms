...
if __name__ == "__main__":
    ...
    tr_h_gas_cho = tr_fl * tr_u_ex_cho + (
        a
        + b * (N * tr_fl)
        + c * ((N * tr_fl) ** 2)
        + d * ((N * tr_fl) ** 3)
    ...
    tr_h_gas_qho = tr_fl * tr_u_ex_qho + (
        a
        + b * (N * tr_fl)
        + c * ((N * tr_fl) ** 2)
        + d * ((N * tr_fl) ** 3)
    ...
    tr_h_solid_cho, tr_h_solid_qho, tr_h_gas, tr_h_solid_cho1, tr_h_solid_qho1 = (
        helmholtz(0, ff, tr_dos, solid_tr_dos, gas_tr_dos)
    )  # translational solid part entropy
    tr_h_cho = tr_h_gas_cho + tr_h_solid_cho
    tr_h_qho = tr_h_gas_qho + tr_h_solid_qho
    tr_e_solid_cho, tr_e_solid_qho, tr_e_gas, tr_e_solid_cho1, tr_e_solid_qho1 = energy(
        0, ff, tr_dos, solid_tr_dos, gas_tr_dos
    )  # translational solid part entropy
    tr_e_cho = (
        N * tr_fl * tr_e_gas_ref + tr_e_solid_cho
    )  # translational part internal energy
    tr_e_qho = N * tr_fl * tr_e_gas_ref + tr_e_solid_qho
    tr_s_solid_cho, tr_s_solid_qho, tr_s_gas, tr_s_solid_cho1, tr_s_solid_qho1 = (
        entropy(0, ff, tr_dos, solid_tr_dos, gas_tr_dos)
    )  # translational solid part energy
    tr_s_cho = (
        N * tr_fl * tr_e_gas_ref - tr_h_gas_cho
    ) / T + tr_s_solid_cho  # translational part entropy
    ...
    print(
        "Gas part of Total Translational Helmholtz energy of the system (assuming IAG approximation for gas part and cho for reference) scales with N (normalized by beta) = ",
        tr_h_gas_cho / (kb * T),
        file=out,
    )
    print(
        "Gas part of Total Translational Helmholtz energy of the system (assuming IAG approximation for gas part and qho for reference) scales with N (normalized by beta) = ",
        tr_h_gas_qho / (kb * T),
        file=out,
    )
    print(
    ...
    print(
        "Gas part of Total Translational energy of the system (assuming IAG approximation for gas part) scales with N (normalized by beta) = ",
        (N * tr_fl * tr_e_gas_ref) / (kb * T),
        file=out,
    )
    print(
    ...
    print(
        "Gas part of Total Translational Entropy of the system (assuming IAG approximation for gas part and cho for the solid part) scales with N (normalized by beta) = ",
        (N * tr_fl * tr_e_gas_ref - tr_h_gas_cho) / (kb * T),
        file=out,
    )
    print(
        "Gas part of Total Translational Entropy of the system (assuming IAG approximation for gas part and qho for the solid part) scales with N (normalized by beta) = ",
        (N * tr_fl * tr_e_gas_ref - tr_h_gas_qho) / (kb * T),
        file=out,
    )
    print(
